...
<link rel="stylesheet" type="text/css"
	href="${ctx }/page/major/css/index.css">
</head>
<body class="easyui-layout">
	...
	<div id="toolbar" class="datagrid-toolbar">
		...
		<div style="margin-bottom:5px">
			<a href="javascript:void(0)" id="addbtn" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">新增专业</a> 
				<a href="javascript:void(0)" id="editbtn" class="easyui-linkbutton" iconCls="icon-edit" plain="true">编辑专业</a>
				<a
				href="javascript:void(0)" id="removebtn" class="easyui-linkbutton"
				onclick="testonline.major.deleteSubmit()" iconCls="icon-remove"
				plain="true">删除选中项</a> 
		</div>
	...
	<div id="adddlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			...
			<div class="fitem">
				<label><span>*</span>名称：</label> <input name="majorName"
			...
			<div class="fitem">
				<label><span>*</span>描述：</label> <input name="majorDesc"
					class="easyui-validatebox" required="true" class="easyui-combobox"
					id="majorDesc">
			</div>
		</form>
	...
	<div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" id="submitBtn"
			onclick="testonline.major.addSubmit()">提交</a> <a href="#"
	...
	<script type="text/javascript" src="${ctx }/page/major/js/index.js"></script>
</body>
</html>